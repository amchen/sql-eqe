if exists(select * from SYSOBJECTS where ID = object_id(N'absp_Util_UpdateStatistics') and objectproperty(ID,N'IsProcedure') = 1)
begin
   drop procedure absp_Util_UpdateStatistics
end
go

create procedure absp_Util_UpdateStatistics
as
...
====================================================================================================
DB Version: MSSQL
Purpose:    This procedure updates statistics on the primary database.
Returns:    Nothing
====================================================================================================
</pre>
</font>
...
begin
    ...
    begin
        ...
        -- wait for 1 minutes - Reduced this from 2 to 1 because the DBs are small
        WAITFOR DELAY '00:01';
