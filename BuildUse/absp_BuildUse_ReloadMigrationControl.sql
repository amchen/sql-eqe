if exists(select 1 from SYSOBJECTS where ID = object_id(N'absp_BuildUse_ReloadMigrationControl') and objectproperty(id,N'IsProcedure') = 1)
begin
   drop procedure absp_BuildUse_ReloadMigrationControl;
end
go

create procedure absp_BuildUse_ReloadMigrationControl
/*
##BD_BEGIN
<font size ="3">
...
*/
	select * from systemdb.dbo.MigrationControl
		order by Defect, OnHold, QAEngineer, Build;
