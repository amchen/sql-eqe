if exists(select * from SYSOBJECTS where ID = object_id(N'absp_InvalidateResultsUpDown') and objectproperty(ID,N'IsProcedure') = 1)
begin
   drop procedure absp_InvalidateResultsUpDown
end
go

create  procedure absp_InvalidateResultsUpDown  @nodeKey int, @nodeType int, @isForceInvalidation int=0, @actionType varchar(30) = 'InvalidateUpDownNodes'
/*
##BD_BEGIN
<font size ="3">
