if exists(select * from SYSOBJECTS where ID = object_id(N'absp_InvalidateResultsUpAndSelf') and objectproperty(ID,N'IsProcedure') = 1)
begin
   drop procedure absp_InvalidateResultsUpAndSelf
end
go

create  procedure absp_InvalidateResultsUpAndSelf  @nodeKey int, @nodeType int, @isForceInvalidation int=0,@actionType varchar(30) = 'InvalidateUpNodesAndSelf'
/*
##BD_BEGIN
<font size ="3">
