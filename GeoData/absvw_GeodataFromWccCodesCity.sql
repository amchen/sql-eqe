if exists(select * from SYSOBJECTS where ID = object_id(N'absvw_GeodataFromWccCodesCity') and objectproperty(id,N'IsView') = 1)
begin
   drop view absvw_GeodataFromWccCodesCity
end
go
Create view absvw_GeodataFromWccCodesCity
as
select 1 as GEOROW_KEY,
 ...
 CAST(300 as smallint) as GEO_STAT,
