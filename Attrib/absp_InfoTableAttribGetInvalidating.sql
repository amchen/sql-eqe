if exists(SELECT 1 from SYSOBJECTS where ID = object_id(N'absp_InfoTableAttribGetInvalidating') and OBJECTPROPERTY(id,N'IsProcedure') = 1)
begin
   drop procedure absp_InfoTableAttribGetInvalidating
end
go
 
create procedure absp_InfoTableAttribGetInvalidating @setting bit output, @nodeType integer, @nodeKey integer   
/*
##BD_BEGIN  
<font size ="3">
...
Purpose:
     ...
     This procedure gets the 'INVALIDATING' Attribute settings for the given node and returns it in an
     output parameter. 
