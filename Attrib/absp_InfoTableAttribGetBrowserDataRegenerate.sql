if exists(SELECT * from SYSOBJECTS where ID = object_id(N'absp_InfoTableAttribGetBrowserDataRegenerate') and OBJECTPROPERTY(id,N'IsProcedure') = 1)
begin
   drop procedure absp_InfoTableAttribGetBrowserDataRegenerate
end
go
 
create procedure absp_InfoTableAttribGetBrowserDataRegenerate   @setting bit out, @nodeType integer, @nodeKey integer  
/*
##BD_BEGIN  
<font size ="3">
