if exists(SELECT * from SYSOBJECTS where ID = object_id(N'absp_InfoTableAttribGetBrowserFilterTaskCancel') and OBJECTPROPERTY(id,N'IsProcedure') = 1)
begin
   drop procedure absp_InfoTableAttribGetBrowserFilterTaskCancel
end
go
 
create procedure absp_InfoTableAttribGetBrowserFilterTaskCancel   @setting bit out, @nodeType integer, @nodeKey integer  
as
begin
