if exists(select 1 from SYSOBJECTS where ID = object_id(N'absp_Migr_ApplyHotfix') and objectproperty(id,N'IsProcedure') = 1)
begin
	drop procedure absp_Migr_ApplyHotfix;
end
go

create procedure absp_Migr_ApplyHotfix
	@batchJobKey int,
	@dbType varchar(3)
as
